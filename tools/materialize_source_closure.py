...
def main() -> None:
    ...
    for item in directory_items:
        ...
        if relative in copied or any(parent in copied for parent in relative.parents) or relative in copied_parents: fail("generated directory collides at destination")
