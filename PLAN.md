...
- [x] Rank other LEGO firmware targets and document the CPU, memory, boot,
  radio, and NuttX-port constraints in `docs/en/project/other-hubs.md`.
...
|---|---|---|---|
| 2026-09-07 | Roadmap 2a (source-closure evidence tooling) | Complete | Added deterministic stdlib-only manifest generation and verification from successful strace consumption plus compiler depfiles. It rejects root escapes, missing inputs, escaping symlinks, forbidden/unknown licences, hash drift, and unmanifested files; emits SPDX 2.3 JSON and optional map/object linkage evidence. Black-box tests cover positive determinism and every fail-closed boundary. Source copying and submodule replacement remain a later evidence-driven checkpoint. |
...
| 2026-09-04 | C0.1 | Complete | Baseline cloned from `owhinata/spike-nx` at `00524ea5464bddb46c852967e382f8f6b073abe6`; the migration archive was kept private and the upstream remote retained. |
| 2026-09-04 | C0.2 | Complete | Added `docs/en/project/baseline.md` and `docs/en/project/provenance.md`; recorded exact pins, build/flash inputs, policy exceptions, and unresolved audit items. |
...
| 2026-09-04 | C0.4 | Complete | Private no-artifact run `33915185711` built both protected images after repairing and hash-pinning the dead NuttX-tools archive; versions, sizes, and SHA-256 values recorded in `docs/en/project/baseline.md`. |
...
| 2026-09-04 | C2.1 | Complete | Added `docs/en/project/classic-protocol.md`: separated Scratch Link, RFCOMM/SPP, and hub-stream contracts; inventoried commands/state records/errors/reconnect; identified the outbound-base64 defect and explicitly scoped Python compatibility. |
| 2026-09-04 | C2.2 | Complete | Added `docs/en/project/ble-protocol.md`: both extensions share one FD02 GATT/message protocol; recorded framing, negotiation, notifications, tunnel semantics, errors/reconnect, and extension defects against the published protocol. |
