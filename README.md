...
**Historical upstream instructions only — do not use them with this WIP
derivative. Physical-hardware flashing is unsupported and unsafe until the
hardware-validation gate in `SAFETY.md` is completed.**
