 ...
 *
 * Owns a transport-neutral scheduler timer that fires every
 * CONFIG_APP_BTSENSOR_BUNDLE_TICK_MS (10 ms by default).  Each tick:
 ...
 * 100 Hz wake-ups.
 *
 * Timer teardown synchronizes with an active callback before returning.
 ****************************************************************************/
